...
class HistoryListAdapter extends RecyclerView.Adapter
{
    ...
    HistoryListAdapter(RecyclerView view)
    {
        mListView = view;
        mSelectedCount = 0;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View convertView = LayoutInflater.from(
                parent.getContext()).inflate(R.layout.list_item_history, parent, false);
    ...
    static class ItemViewHolder extends RecyclerView.ViewHolder
    {
        ...
        ItemViewHolder(View itemView)
        {
            ...
            timeTextView = (TextView) itemView.findViewById(R.id.tv_list_item_history_time);
            titleTextView = (TextView) itemView.findViewById(R.id.tv_list_item_history_title);
            siteTextView = (TextView) itemView.findViewById(R.id.tv_list_item_history_site);
            selectionImageView = (ImageView) itemView.findViewById(R.id.iv_list_item_history_select);
        }
    }

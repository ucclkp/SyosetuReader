...
public class FavoriteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTipTextView = (TextView) parent.findViewById(R.id.tv_favorite_fragment_tip);

        mListView = (RecyclerView) parent.findViewById(R.id.rv_favorite_fragment_list);
        mListView.setHasFixedSize(true);
        mListView.setLayoutManager(new LinearLayoutManager(getContext()));
        mListView.setMotionEventSplittingEnabled(false);
        //mListView.addItemDecoration(new FavoriteListDecoration(getContext()));

        mListAdapter = new FavoriteListAdapter(mListView);
